...
class ProductModelsFactory {
    ...
    Pair<DependencyMatrix,List<ProductModel>> create(EconomyParametersModel constants, List<ProductDTO> productDTOs){
        ...
        return new Pair(dependencyMatrix, mapToProductModels(productModels));
    }
